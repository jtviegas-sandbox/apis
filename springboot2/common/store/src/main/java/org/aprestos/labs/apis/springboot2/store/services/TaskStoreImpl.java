...
import org.aprestos.labs.apis.springboot2.model.transform.Task2Dto;
import org.aprestos.labs.apis.springboot2.model.transform.Task2entity;
import org.aprestos.labs.apis.springboot2.store.exceptions.MissingEntityException;
import org.aprestos.labs.apis.springboot2.store.repositories.TaskRepository;
...
public class TaskStoreImpl implements TaskStore {
  ...
  public List<Task> get() {
    ...
    Iterator<org.aprestos.labs.apis.springboot2.model.entities.Task> iterator = taskRepository.findAll().iterator();
  ...
  public Task post(Task obj) {
    ...
    Task result = null;
    org.aprestos.labs.apis.springboot2.model.entities.Task task = mapper2entity.apply(obj);
  ...
  public Optional<Task> get(String id) {
    ...
    Optional<org.aprestos.labs.apis.springboot2.model.entities.Task> data = taskRepository.findById(id);
    if(data.isPresent()) 
